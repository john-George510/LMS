...
from .views import admin_login, register_student, get_students, add_book, issue_book, get_all_books,book, update_book, get_all_book_issues, get_student_books
...
urlpatterns = [
    ...
    path('book/<int:book_id>/', book, name='book'), #DELETE and GET
